...
module.exports = {
  ...
  onRun: function (config, dependencies, jobCallback) {
    ...
    /*
     ...
     It is a good idea to cover this with unit tests as well (see test/timerjob file)
     ...
     Have a look at test/timerjob for an example of how to unit tests this easily by mocking easyRequest calls

     */

    dependencies.easyRequest.JSON('http://autostrada-navit.rhcloud.com/api/v1/activities?last=8d', function (err, activites) {
      logger.trace(activites.length);
      jobCallback(null, {title:'fjes', time: +activites.length});
    });
  }
};