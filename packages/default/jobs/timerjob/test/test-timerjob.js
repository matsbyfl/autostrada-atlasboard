/**
 * Test file for Job: timerjob
 */

var assert = require ('assert');
var timerjobSUT = require('../timerjob');

var mockedConfig, mockedDependencies;

describe ('timerjob test', function(){
  ...
  describe ('http request example tests', function(){
    it('should handle server errors', function (done){
      ...
      var config = {};
      timerjobSUT.onRun(config, mockedDependencies, function(err, data){
